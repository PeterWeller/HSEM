package preprocess;
//hdfs://10.11.1.51:9000/input/tokens_20000000_charTriGram.txt hdfs://10.11.1.51:9000/SortedDictionary/
...
public class DictionaryGeneration {
    ...
    //降序输出
     ...
     //升序输出
     private static class IntWritableIncreasingComparator extends IntWritable.Comparator {
         public int compare(WritableComparable a, WritableComparable b) {
           return super.compare(a, b);
         }
    ...
    public static void main(String[] args) throws Exception {
        ...
        job.setJarByClass(DictionaryGeneration.class);
        try{
            ...
            if(job.waitForCompletion(true))
            {
                ...
                sortJob.setJarByClass(DictionaryGeneration.class);
